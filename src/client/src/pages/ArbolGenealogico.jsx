...
const nodosGen1 = [
  {
    id: 1, nombre: 'Arthur Morales', rol: 'Generación I', tipo: 'creador', tieneHijos: true,
    img: 'https://ui-avatars.com/api/?name=Arthur+Morales&background=e2e8f0&color=475569',
    fechaCorta: '1945 - 2020',
  ...
  {
    id: 2, nombre: 'Rosa Morales', rol: 'Generación I', tipo: 'admin', tieneHijos: true,
    img: 'https://ui-avatars.com/api/?name=Rosa+Morales&background=fca5a5&color=7f1d1d',
    fechaCorta: '1948 - Presente',
...
const nodosGen2 = [
  {
    id: 3, nombre: 'Carlos Morales', rol: 'Generación II', tipo: 'admin', tieneHijos: false,
    img: 'https://ui-avatars.com/api/?name=Carlos+Morales&background=bae6fd&color=0c4a6e',
    fechaCorta: '1970 - Presente',
  ...
  {
    id: 4, nombre: 'Elena Morales', rol: 'Generación II', tipo: 'normal', tieneHijos: true,
    img: 'https://ui-avatars.com/api/?name=Elena+Morales&background=0D1B2A&color=fff',
    fechaCorta: '1975 - Presente',
  ...
  {
    id: 5, nombre: 'Maria Garcia', rol: 'Generación II', tipo: 'normal', tieneHijos: false,
    img: 'https://ui-avatars.com/api/?name=Maria+Garcia&background=fef08a&color=713f12',
    fechaCorta: '1978 - Presente',
...
const nodosGen3 = [
  {
    id: 6, nombre: 'Leo Morales', rol: 'Generación III', tipo: 'normal', tieneHijos: false,
    img: 'https://ui-avatars.com/api/?name=Leo+Morales&background=bbf7d0&color=082f49',
    fechaCorta: '2000 - Presente',
  ...
  {
    id: 7, nombre: 'Mia Morales', rol: 'Generación III', tipo: 'normal', tieneHijos: false,
    img: 'https://ui-avatars.com/api/?name=Mia+Morales&background=fbcfe8&color=831843',
    fechaCorta: '2004 - Presente',
...
const Nodo = ({ nombre, fechaCorta, tipo, img, tieneHijos, onClick }) => {
  return (
    <div className="nodo-tarjeta shadow-sm" onClick={onClick}>
      ...
      <div className="info-nodo">
        <h6 className="nombre-nodo text-truncate" style={{ maxWidth: '120px' }} title={nombre}>{nombre}</h6>
        <span className="fecha-nodo">{fechaCorta}</span>
      </div>

      {tieneHijos && (
        <button className="btn-expandir" title="Ver descendencia">
  ...
  return (
    <div className="contenedor-arbol">
      ...
      <div className="tarjeta-arbol shadow-sm p-0 position-relative">
        ...
        <div className="controles-zoom position-absolute m-3 d-flex flex-column gap-2 z-3">
        ...
        <div className="lienzo-arbol">
          ...
          <ConexionOrtogonal type="ortogonal-2" />
          ...
          <ConexionOrtogonal type="ortogonal-3" />
